...
public class MyLinkedList {
	...
	private MyLinkedList reverse(ListNode node) {
		...
		MyLinkedList sub = reverse(node.next);
		
		sub.addLast(node.data);
		
		return sub; // change this line of code as needed
	}
	 ...
	 * the existing list node. For example, list1 = []窶�>[A]窶�>[B],
	...
	private ListNode reverse(ListNode first, ListNode second) {
		...
		return h; //change this line of code as needed.
	}
