...
public class Hashtable {
   ...
   // Code for Object get(Object key)    
   public Object get(Object key)
   {  
      if(key == null)
         throw new NullPointerException("key passed in is null");
      ...
      if(this.contains(key))
      {
         ...
         // Create reference to the supposedly linked list object in hashtable
         LinkedList<HashtableRecord> theList = (LinkedList<HashtableRecord>) this.table[pos];
         
         int i = 0;
         
         while(theList != null && i < theList.size())
         {
            if(node.key.equals(theList.get(i).key))
               return theList.get(i).value;
